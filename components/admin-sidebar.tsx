...
const menuGroups = [
  ...
  },
  {
    label: "Kelas",
    items: [
      { icon: IconBook, label: "Programs", path: "/admin/programs" },
      { icon: IconStack2, label: "Sections", path: "/admin/sections" },
      {
  ...
  },
  {
    ...
    items: [
      ...
      { icon: IconCalendar, label: "Schedule", path: "/admin/schedule" },
    ],
  },
  {
    label: "Keuangan",
    items: [
      { icon: IconCash, label: "Payments", path: "/admin/payments" },
      { icon: IconFileInvoice, label: "Invoices", path: "/admin/invoices" },
    ],
  },
  {
    label: "Laporan",
